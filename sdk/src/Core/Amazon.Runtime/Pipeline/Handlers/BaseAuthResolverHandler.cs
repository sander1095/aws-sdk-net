    ...
    public class BaseAuthResolverHandler : PipelineHandler
    {
        ...
        protected void PreInvoke(IExecutionContext executionContext) 
        {
            ...
            foreach (var authOption in authOptions)
            {
                ...
                if (scheme.IdentityResolver == null)
                {
                    // Current auth scheme does not have an identity resolver configured, continue iterating.
                    continue;
                }

                var identity = scheme.IdentityResolver.ResolveIdentity();

                // TODO: Retrieve signer for the current scheme and attach them to request context.
                ...
                // - For SSO (bearer token), the "AWSTokenProvider" property on the client config could be set already.
            }
        }
